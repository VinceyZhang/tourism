 ...
 */
'use strict';
cBoard.controller('dataManagerWidgetCtrl', function ($scope, $stateParams, $http, $uibModal, dataService, ModalUtils, updateService, $filter, chartService, $timeout) {
    ...
    $scope.chart_types_status = {
        "line": false, "pie": false, "kpi": false, "table": true,
        "funnel": false, "sankey": false, "radar": false, "map": false
    };
